    ...
    return (
        <div className="navbar__container">
            <div className="navbar__grid-item">
                <Link><h1 className="navbar__head" onClick={toggle_home}>{name}</h1></Link>
            ...
            <div className="navbar__grid-item">
                <ul className={click ? "navbar__links-wrapper navbar__active" : "navbar__links-wrapper"}>
                    ...
                    <Link to='carrier' spy={true} smooth={true} offset={-50} duration={1000} className="navbar__link" onClick={closeMobileMenu}>
                        <li className="navbar__link-item">
                            Carrier
                        </li>
                    </Link>
                    <Link to='projects' spy={true} smooth={true} offset={-50} duration={1000} className="navbar__link" onClick={closeMobileMenu}>
                        <li className="navbar__link-item">
                            Projects
                        </li>
                    </Link>
                    <Link to='contact-me' spy={true} smooth={true} offset={-50} duration={1000} className="navbar__link" onClick={closeMobileMenu}>
                        <li className="navbar__link-item">
                            Contact Me
                        </li>
                    </Link>
